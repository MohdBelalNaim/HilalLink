  ...
  return (
    <>
      <div className={`mb-2 relative ${hide && "hidden"}`}>
        <div
          className="bg-white px-4 py-3 border-b text-[12px] text-gray-500 relative"
        ...
        <div className="relative">
          ...
          <div className="flex justify-between bg-white p-3">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs max-sm:text-[11px] text-gray-500">
                    {data?.original_user?.city}, {data?.original_user?.state},{" "}
                    {data?.original_user?.country}
                  </div>
                  <div className="text-xs max-sm:text-[11px] text-gray-500">
            ...
            <div className="flex text-xs items-center gap-3 text-gray-500">
              <span className="font-normal text-gray-600 text-xs absolute right-3 top-2.5">
                {date}
              </span>
          ...
          {data?.text && (
            <Link to={`/post-details/${data?.original_postId?._id}`}>
